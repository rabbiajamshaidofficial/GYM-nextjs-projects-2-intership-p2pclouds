// // app/contact/page.tsx or components/ContactUsPage.tsx
...
//                 <p>123 P2P Cloud Tower, Tech Hub City, 90010</p>
//               </div>
//               <div>
//                 <h3 className="font-semibold text-lg text-blue-400 mb-1">Email</h3>
//                 <p className="hover:text-blue-500 transition">support@p2pcloud.com</p>
//               </div>
//               <div>
